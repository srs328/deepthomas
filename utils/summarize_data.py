...
def summarize_monai_bundles(root_dir):
    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        ...
        if (
            ...
            or "training_work_dirs" in dirpath
        ):
            manifest_path = os.path.join(dirpath, ".bundle_structure_manifest.txt")
...
if __name__ == "__main__":
    ...
    dirpath = "/home/srs-9/Projects/saranathan/kira_share/deepthomas/training_work_dirs"
    summarize_folder(dirpath)